...
contract OriginERC20Token is ERC20Permit, VaultOwned {
    using SafeMath for uint256;

    constructor() ERC20("Longinus", "LGNS", 9) {}
...
contract OriginWithLottery is OriginERC20Token {
    using SafeMath for uint256;
    ...
    constructor(address _feeReceiver, address _buyFeeReceiver, uint _buyFeeRatio) OriginERC20Token() {
